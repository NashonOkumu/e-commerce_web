        ...
        <div class="container-fluid">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    $sql = "SELECT * FROM assigned_deliveries WHERE status ='completed'";
                ...
                <?php
                $sql = "SELECT SUM(t_amount) AS value_sum FROM assigned_deliveries WHERE status='Completed' ";
                $result = mysqli_query($con, $sql);
                $row = mysqli_fetch_assoc($result);
                $total = $row['value_sum'];

                ?>
                <p style="text-align: center">Total Amount: Ksh. <?php echo $total;?></p>
            </div>
        </div>
    </div>
